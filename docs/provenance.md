...
## Category boundaries (characters, animation, 2d, tools, video)
...
**`video/` holds archival / stock footage** you ship as FMV, cutscenes, in-world screens, or billboard loops. Shot indexes like Destockd live here. Do not refile mocap into video. NASA stills+video stay in `environment/` until a later pass splits government media.
