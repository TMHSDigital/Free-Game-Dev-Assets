...
- `publisher`: optional. Set when the same rights-holding publisher has more than one catalog entry (Kenney, Quaternius, KayKit, Google Fonts, OpenGameArt, LuizMelo, 0x72, Blender Studio, Material Maker, Tiny Speck, Screaming Brain Studios, Sparklin, Alif Type). Do not set this to a generic host (GitHub, Hugging Face).
